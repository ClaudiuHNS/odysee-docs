...
# Filtering comments
- no filtering tools
- just the backend shadowbanning, which is a bit more intense than on YT, because here there's no way to see shadowbanned comments regardless how important they may be to you.
